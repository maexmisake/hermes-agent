...
export const en: Translations = {
  ...
  sidebar: {
    ...
    allInFolders: 'Every chat is filed in a project or a group.',
    groups: {
      sectionLabel: 'Groups',
      newButton: 'New group',
      createTitle: 'New group',
      createDesc: 'A group is just a name. It tidies chats without moving any files.',
      renameTitle: 'Rename group',
      namePlaceholder: 'e.g. Shipping Friday',
      empty: 'No groups yet. A group tidies chats without moving their files.',
      menu: 'Actions',
      rename: 'Rename…',
      delete: 'Delete group',
      deleteConfirm: (name: string) => `Delete the group “${name}”? Its chats stay exactly where they are.`,
      deleteFailed: 'Could not delete the group',
      reorderFailed: 'Could not reorder the groups',
      filedIn: (name: string) => `Filed in ${name}`
    },
    projects: {
      empty: 'No projects yet. A project is a folder Hermes works in.',
  ...
  chat: {
    context: {
      ...
      folderTitle: 'Folder',
      noFolder: 'No folder',
      inGroup: name => `In ${name}`,
      addToGroup: 'Add to group',
      branchTitle: 'Branch',
      branchSwitched: branch => `Now on ${branch}`,
      branchFailed: 'Could not switch branch',
      changeProject: 'Work in another project…',
      chooseFolder: 'Choose a folder…',
      moveTitle: 'Move this chat?',
      moveConfirm: place =>
        `This chat will start working in ${place}. Its terminal and file tools follow, so anything it runs next happens there.`,
      moveConfirmLabel: 'Move it',
      moved: place => `Now working in ${place}`,
      moveFailed: 'Could not move the chat'
    }
  },
