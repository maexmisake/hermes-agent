...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    allInFolders: 'كل محادثة مُصنَّفة ضمن مشروع أو مجموعة.',
    groups: {
      sectionLabel: 'المجموعات',
      newButton: 'مجموعة جديدة',
      createTitle: 'مجموعة جديدة',
      createDesc: 'المجموعة مجرد اسم. تُرتِّب المحادثات دون نقل أي ملفات.',
      renameTitle: 'إعادة تسمية المجموعة',
      namePlaceholder: 'مثال: إصدار الجمعة',
      empty: 'لا توجد مجموعات بعد. المجموعة تُرتِّب المحادثات دون نقل ملفاتها.',
      menu: 'إجراءات',
      rename: 'إعادة تسمية…',
      delete: 'حذف المجموعة',
      deleteConfirm: (name: string) => `حذف المجموعة «${name}»؟ ستبقى محادثاتها كما هي.`,
      deleteFailed: 'تعذّر حذف المجموعة',
      reorderFailed: 'تعذّرت إعادة ترتيب المجموعات',
      filedIn: (name: string) => `مُصنَّفة في ${name}`
    },
    projects: {
      empty: 'لا توجد مشاريع بعد. المشروع هو المجلد الذي يعمل فيه Hermes.',
