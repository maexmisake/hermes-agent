...
export const ru = defineLocale({
  ...
  sidebar: {
    ...
    allInFolders: 'Каждый чат разложен по проекту или группе.',
    groups: {
      sectionLabel: 'Группы',
      newButton: 'Новая группа',
      createTitle: 'Новая группа',
      createDesc: 'Группа — это просто имя. Она упорядочивает чаты, не перемещая файлы.',
      renameTitle: 'Переименовать группу',
      namePlaceholder: 'например: Релиз в пятницу',
      empty: 'Групп пока нет. Группа упорядочивает чаты, не перемещая их файлы.',
      menu: 'Действия',
      rename: 'Переименовать…',
      delete: 'Удалить группу',
      deleteConfirm: (name: string) => `Удалить группу «${name}»? Её чаты останутся на месте.`,
      deleteFailed: 'Не удалось удалить группу',
      reorderFailed: 'Не удалось изменить порядок групп',
      filedIn: (name: string) => `В группе ${name}`
    },
    projects: {
      empty: 'Проектов пока нет. Проект — это папка, в которой работает Hermes.',
      ...
      moveNoGroups: 'Групп пока нет',
      moveNoGroup: 'Без группы',
  ...
  chat: {
    context: {
      ...
      folderTitle: 'Папка',
      noFolder: 'Без папки',
      inGroup: name => `В группе ${name}`,
      addToGroup: 'Добавить в группу',
      branchTitle: 'Ветка',
      branchSwitched: branch => `Теперь ветка ${branch}`,
      branchFailed: 'Не удалось переключить ветку',
      changeProject: 'Работать в другом проекте…',
      chooseFolder: 'Выбрать папку…',
      moveTitle: 'Перенести этот чат?',
      moveConfirm: place =>
        `Чат начнёт работать в ${place}. Терминал и файловые инструменты последуют за ним, поэтому всё дальнейшее выполнится там.`,
      moveConfirmLabel: 'Перенести',
      moved: place => `Теперь работает в ${place}`,
      moveFailed: 'Не удалось перенести чат'
    }
  },
