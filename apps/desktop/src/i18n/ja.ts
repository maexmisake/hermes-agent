...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    allInFolders: 'すべてのチャットはプロジェクトかグループに整理されています。',
    groups: {
      sectionLabel: 'グループ',
      newButton: '新しいグループ',
      createTitle: '新しいグループ',
      createDesc: 'グループは名前だけです。ファイルを移動せずにチャットを整理します。',
      renameTitle: 'グループの名前を変更',
      namePlaceholder: '例: 金曜リリース',
      empty: 'グループがまだありません。グループはファイルを移動せずにチャットを整理します。',
      menu: '操作',
      rename: '名前を変更…',
      delete: 'グループを削除',
      deleteConfirm: (name: string) => `グループ「${name}」を削除しますか？チャットはそのまま残ります。`,
      deleteFailed: 'グループを削除できませんでした',
      reorderFailed: 'グループを並べ替えられませんでした',
      filedIn: (name: string) => `${name} に整理済み`
    },
    projects: {
      empty: 'プロジェクトがまだありません。プロジェクトは Hermes が作業するフォルダーです。',
