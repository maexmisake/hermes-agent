...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    allInFolders: '每个对话都已归入项目或分组。',
    groups: {
      sectionLabel: '分组',
      newButton: '新建分组',
      createTitle: '新建分组',
      createDesc: '分组只是一个名称，用于整理对话，不会移动任何文件。',
      renameTitle: '重命名分组',
      namePlaceholder: '例如：周五发布',
      empty: '还没有分组。分组用于整理对话，不会移动文件。',
      menu: '操作',
      rename: '重命名…',
      delete: '删除分组',
      deleteConfirm: (name: string) => `删除分组“${name}”？其中的对话会保持原样。`,
      deleteFailed: '无法删除分组',
      reorderFailed: '无法重新排序分组',
      filedIn: (name: string) => `已归入 ${name}`
    },
    projects: {
      empty: '还没有项目。项目就是 Hermes 工作的文件夹。',
  ...
  chat: {
    context: {
      ...
      folderTitle: '文件夹',
      noFolder: '无文件夹',
      inGroup: name => `位于 ${name}`,
      addToGroup: '加入分组',
      branchTitle: '分支',
      branchSwitched: branch => `已切换到 ${branch}`,
      branchFailed: '无法切换分支',
      changeProject: '改在其他项目中工作…',
      chooseFolder: '选择文件夹…',
      moveTitle: '移动此对话?',
      moveConfirm: place => `此对话将改在 ${place} 中工作。终端和文件工具也会随之改变,之后的所有操作都在那里执行。`,
      moveConfirmLabel: '移动',
      moved: place => `现在在 ${place} 中工作`,
      moveFailed: '无法移动此对话'
    }
  },
