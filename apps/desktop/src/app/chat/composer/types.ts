...
export interface ChatBarProps {
  ...
  cwd?: string | null
  /** The new-chat setup bubbles, rendered in the floating strip above the surface.
   *  The caller decides when a chat is still a fresh draft; absent means it isn't. */
  setupRow?: ReactNode
