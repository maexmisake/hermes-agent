      ...
      <ComposerPrimitive.Unstable_TriggerPopoverRoot>
        ...
        >
          ...
          <div className={cn(composerFloatingStrip, 'px-[5px] pb-1.5 empty:hidden')}>
            {/* Setup bubbles lead the strip: they describe what this chat is about
                to work on, which is the thing you read before anything offered
                about it. Present only until the first message, then gone. */}
            {setupRow}
